...
#ifndef __ZFL_PRELUDE_H_INCLUDED__
#define __ZFL_PRELUDE_H_INCLUDED__
...
#   define ZFL_ASSERT_SANE_FUNCTION    __FUNCTION__
#else
...
#       define ZFL_EXPORT __declspec(dllexport)
#   else
#       define ZFL_EXPORT __declspec(dllimport)
#   endif
#else
#   define ZFL_EXPORT
#endif
